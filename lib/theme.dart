...
final lightThemeProvider = Provider<ThemeData>((ref) => _theme);
...
final _theme = ThemeData(
  ...
  dialogTheme: DialogTheme(
    ...
    backgroundColor: AppColorsLight.backgroundColor,
    titleTextStyle: const TextStyle(color: AppColorsLight.textColor1, fontSize: 16),
    contentTextStyle: const TextStyle(color: AppColorsLight.textColor1, fontSize: 16),
  ),
  appBarTheme: AppBarTheme(
    elevation: 0.0,
    actionsIconTheme: const IconThemeData(color: AppColorsLight.iconColor),
  ...
  iconTheme: const IconThemeData(color: AppColorsLight.iconColor),
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: AppColorsLight.greenColor),
  dividerTheme: const DividerThemeData(color: AppColorsLight.greyColor, thickness: 0.1),
...
final _darkTheme = ThemeData(
  ...
  dialogTheme: DialogTheme(
    ...
    titleTextStyle: const TextStyle(color: AppColorsDark.textColor1, fontSize: 16),
    contentTextStyle: const TextStyle(color: AppColorsDark.textColor1, fontSize: 16),
  ),
  appBarTheme: AppBarTheme(
    elevation: 0.0,
    actionsIconTheme: const IconThemeData(color: AppColorsDark.iconColor),
    backgroundColor: AppColorsDark.appBarColor,
    systemOverlayStyle: SystemUiOverlayStyle(
      statusBarIconBrightness: Brightness.light,
  ...
  iconTheme: const IconThemeData(color: AppColorsDark.iconColor),
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: AppColorsDark.greenColor),
  dividerTheme: const DividerThemeData(color: AppColorsDark.greyColor, thickness: 0.1),
  tabBarTheme: const TabBarTheme(
    indicatorColor: AppColorsDark.indicatorColor,
    indicatorSize: TabBarIndicatorSize.tab,
...
extension CustomTheme on ThemeData {
  ...
  AssetImage themedImage(String name) {
    final path = brightness == Brightness.dark? 'assets/images/dark' : 'assets/images';
